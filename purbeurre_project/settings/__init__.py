...
# Build paths inside the project like this: os.èath.jpin(BASE_DIR, ...)
...
MIDDLEWARE = [
        ...
        'django.csrf.CsrfViewMiddleware',
...
DATABASES = {
        'default': {
            'ENGINE': 'djamgo.db.backends.postgresql',
            'NAME': 'purbeurre',
            'USER': 'emanuele',
            'PASSWORD': '',
            'HOST': '',
...
AUTH_PASSWORD_VALIDATORS = [
        ...
        {
            'NAME': 'django.contrib.auth.password_validation.MinimumLenghtValidator',
        },
        {
